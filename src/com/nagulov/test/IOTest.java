...
public class IOTest {
	...
	public void testServiceIO() {
		...
		assertNotNull(ServiceController.getInstance().getServices().get("Service").getTreatment("Treatment"));
		assertNotNull(ServiceController.getInstance().getServices().get("Service").getTreatment("Treatment2"));
		assertNotNull(ServiceController.getInstance().getServices().get("Service2").getTreatment("Treatment3"));
	}
